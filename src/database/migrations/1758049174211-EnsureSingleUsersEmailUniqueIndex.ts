...
export class EnsureSingleUsersEmailUniqueIndex1758049174211 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE IF EXISTS users ADD CONSTRAINT IF NOT EXISTS users_email_key UNIQUE (email);`);
  }
}
