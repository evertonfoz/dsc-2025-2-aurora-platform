...
describe('AuthController – refresh', () => {
  ...
  it('POST /auth/refresh → delega ao service.refresh', async () => {
    ...
    const body = { refreshToken: 'tok' } as import('../../../src/auth/dtos/refresh.dto').RefreshDto;
    const req = { get: (k: string) => (k === 'user-agent' ? 'ua2' : undefined) } as unknown as import('express').Request;
